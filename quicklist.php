...
<?php
  ...
  $_base_utils->initialize_page_compass("Quicklist");
?>
<?php
        ...
        <div class="www-core-container">
            ...
            <div class="manage-top">
                <div style="width: 100%;border-top: 1px solid #CACACA;border-bottom: 1px solid #CACACA;">
                    <h3 style="margin-top: 0px;padding: 16px;"><span style="color: #03a;">My Account ▼ /</span> Quicklist</h3>
                </div>
            </div>
                <?php
                    ...
                    $stmt->close();
                ?>
            <div class="manage-base" style="position: relative;bottom: -6px;left: 6px;">
                    <?php
                    ...
                    ?> 
                        <div class="grid-item" style="animation: scale-up-recent 0.4s cubic-bezier(0.390, 0.575, 0.565, 1.000) both;">
                            ...
                            <a href="/get/delete_quicklist_video?id=<?php echo $id; ?>"><button class="www-button www-button-grey">Delete</button></a>
                        </div>
                    <?php } } ?><br><br>
                <?php for($page = 1; $page<= $number_of_page; $page++) { ?>
                    <a href="quicklist?page=<?php echo $page ?>" style="padding: 3px;">
