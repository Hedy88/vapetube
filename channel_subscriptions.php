        ...
        <div class="www-core-container">
            ...
            ?>
                ...
                <div class="channel-box-profle">
                    ...
                    <?php
                            $stmt56 = $conn->prepare("SELECT * FROM subscribers WHERE sender = ? ORDER BY id DESC");
                            ...
                            $stmt = $conn->prepare("SELECT * FROM subscribers WHERE sender = ? ORDER BY id DESC");
                            ...
                            $stmt = $conn->prepare("SELECT * FROM subscribers WHERE sender = ? ORDER BY id DESC LIMIT ?, ?");
