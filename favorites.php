        ...
        <div class="www-core-container">
            ...
            <div class="manage-top">
                <div style="width: 100%;border-top: 1px solid #CACACA;border-bottom: 1px solid #CACACA;">
                    <h3 style="margin-top: 0px;padding: 16px;"><span style="color: #03a;">My Account ▼ /</span> Favorites</h3>
                </div>
            </div>
                <?php
                    $search = $_SESSION['siteusername'];
                    $stmt56 = $conn->prepare("SELECT * FROM favorite_video WHERE sender = ?");
            ...
            <div class="manage-base">
                ...
                <?php for($page = 1; $page<= $number_of_page; $page++) { ?>
                    <a href="favorites?page=<?php echo $page ?>">
