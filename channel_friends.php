        ...
        <div class="www-core-container">
            ...
            ?>
                ...
                <div class="channel-box-profle">
                    ...
                    <?php
                            $stmt56 = $conn->prepare("SELECT * FROM friends WHERE reciever = ? AND status = 'a' ORDER BY id DESC");
                            ...
                            $stmt = $conn->prepare("SELECT * FROM friends WHERE reciever = ? AND status = 'a' ORDER BY id DESC");
                            ...
                            $stmt = $conn->prepare("SELECT * FROM friends WHERE reciever = ? AND status = 'a' ORDER BY id DESC LIMIT ?, ?");
